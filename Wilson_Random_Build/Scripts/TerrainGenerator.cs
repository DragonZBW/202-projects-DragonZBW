...
public class TerrainGenerator : MonoBehaviour
{
    ...
    private void Generate()
    {
        ...
        // SETTING TEXTURES
        // Create terrain layers for each texture
        ...
        for (int i = 0; i < textures.Length; i++)
        {
            ...
            // Save the terrain layer asset and store it in the layers array (this is necessary in order for the terrain to use the TerrainLayers)
            UnityEditor.AssetDatabase.CreateAsset(layer, "Assets/Terrain/Layers/Layer " + i + ".terrainLayer");
            layers[i] = UnityEditor.AssetDatabase.LoadAssetAtPath<TerrainLayer>("Assets/Terrain/Layers/Layer " + i + ".terrainLayer");
        }
...
{
    /// <summary>
    /// The texture. This is what will be painted on a terrain at or above minHeight.
    /// </summary>
